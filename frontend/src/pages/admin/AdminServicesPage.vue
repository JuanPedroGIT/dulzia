...
import { apiGetServices, apiGetService, apiGetCategories, apiCreateService, apiUpdateService, apiDeactivateService, apiActivateService, apiSetServiceFeatured } from '@/services/adminService'
...
onMounted(() => { fetchServices(); fetchCategories() })
function openCreate() {
  ...
  <div class="admin">
    <header class="admin-page-header">
      <div class="admin-header__inner">
        ...
        <h1 class="header-title">🍭 Secciones</h1>
    ...
    <main class="admin-main">
      <p class="intro">
        Los servicios que aparecen en la web. El check de «Portada» decide cuáles salen
        en las tarjetas del inicio y en la parrilla de la portada.
      </p>
...
.admin-header__inner{max-width:1000px;margin:0 auto;display:flex;align-items:center;gap:1rem}
.btn-back{padding:.45rem .9rem;background:transparent;border:1.5px solid #d0ccc8;border-radius:8px;cursor:pointer;font-size:.85rem;color:#555;text-decoration:none;transition:border-color .2s,color .2s;white-space:nowrap}
.btn-back:hover{border-color:#c8748a;color:#c8748a}
.header-title{font-size:1.05rem;font-weight:700;color:#1a1a1a;flex:1;margin:0}
.admin-main{max-width:1000px;margin:0 auto;padding:2rem 1.5rem}
.intro{font-size:.875rem;color:#888;margin:0 0 1.25rem;line-height:1.6}
