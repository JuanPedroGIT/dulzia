        ...
        <div class="footer__grid">
          ...
          <div class="footer__col">
            ...
            <ul class="footer__list">
              <li><router-link to="/servicios">Carrito Hot Dog</router-link></li>
              <li><router-link to="/servicios">Candy Bar</router-link></li>
              <li><router-link to="/servicios">Fuente de Chocolate</router-link></li>
              <li><router-link to="/servicios">Photocall</router-link></li>
              <li><router-link to="/servicios">Glitter Bar</router-link></li>
            </ul>
          </div>
...
// Teléfono, email y enlace de WhatsApp salen de los datos de contacto
// configurados en el panel (con los de siempre como respaldo).
...
.footer {
  ...
  &__grid {
    ...
    @include respond-to(lg) { grid-template-columns: 2fr 1fr 1fr 1.5fr; }
  }
